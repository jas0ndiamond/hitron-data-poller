# us_ofdm.gp — Plot upstream OFDM measurements over time
...
set title "Upstream OFDM: Transmission Power over Time"
set grid
set xdata time
...
# Step 2: plot upstream OFDM data (columns: timestamp, uschindex, frequency_Hz, digAtten, digAttenBo, repPower, repPower1_6)
# Plot repPower (column 6) and digAtten (column 4)
plot DATA_FILE using 1:6 with lines title "repPower (dBmV)", \
